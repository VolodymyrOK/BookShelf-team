 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xt=new T(5e3,15e3),qt="__/auth/iframe",$t="emulator/auth/iframe",Kt={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Yt=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Jt(e){const t=e.config;y(t.authDomain,e,"auth-domain-config-required");const i=t.emulator?S(t,$t):`https://${e.config.authDomain}/${qt}`,s={apiKey:t.apiKey,appName:e.name,v:r.SDK_VERSION},o=Yt.get(e.config.apiHost);o&&(s.eid=o);const a=e._getFrameworks();return a.length&&(s.fw=a.join(",")),`${i}?${(0,n.querystring)(s).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
